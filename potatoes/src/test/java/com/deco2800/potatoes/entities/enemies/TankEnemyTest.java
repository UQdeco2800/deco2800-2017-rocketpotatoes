...
public class TankEnemyTest extends BaseTest {
	...
	public void emptyConstructor() {
		...
		assertEquals(Color.RED, tank1.getProgressBar().getColours().get(0));
		assertEquals(Color.ORANGE, tank1.getProgressBar().getColours().get(0));
		assertEquals(Color.YELLOW, tank1.getProgressBar().getColours().get(0));
	}
