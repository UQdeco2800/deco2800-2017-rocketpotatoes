...
public class ExplosionEffect extends Effect {
	...
	private static String effectType = "explosion";
...
//				effectHeight, damage, range, effectType);
		super(targetClass, posX - (effectWidth / 2), posY - (effectHeight / 2), 0, effectWidth + 3, effectHeight + 3, 0, effectWidth,
				effectHeight, damage, range, effectType);
	...
	private static float[] pos(float posX, float posY) {
		...
		Texture tex = reg.getTexture(effectType);
