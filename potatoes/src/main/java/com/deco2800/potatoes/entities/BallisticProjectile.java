...
public class BallisticProjectile extends Projectile{
	...
	/**
	 * Creates a new Ballistic Projectile.
	 * Ballistic Projectiles do not change direction once fired.
	 * The initial direction is based on the direction to the closest entity
	 * @param posX
	 * 				x start position
	 * @param posY
	 * 				y start position
	 ...
	 * 				Projectile damage
	 */
	public BallisticProjectile(float posX, float posY, float posZ, Optional<AbstractEntity> target, float RANGE, float DAMAGE) {
