...
public class MeleeEnemy extends AbstractEnemy implements Tickable {
    private int hp;
    private int speed;
    ...
    /**
     * Constructor for base melee enemy
     */
    /**
     ...
     * @param reloadTime
     *            The time taken before another melee attack is ready
     *
     */
    public MeleeEnemy(float posX, float posY, float posZ, float xLength, float yLength, float zLength,
                         String texture, float maxHealth, int reloadTime) {
     ...
     */
    public MeleeEnemy(float posX, float posY, float posZ, float xLength, float yLength, float zLength,
                         float xRenderLength, float yRenderLength, String texture, float maxHealth, int reloadTime) {
     ...
     */
    public MeleeEnemy(float posX, float posY, float posZ, float xLength, float yLength, float zLength,
                         float xRenderLength, float yRenderLength, boolean centered, String texture, float maxHealth, int reloadTime) {
