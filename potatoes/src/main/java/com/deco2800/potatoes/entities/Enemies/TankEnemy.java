...
public class TankEnemy extends AbstractEnemy implements Tickable, HasProgress {
	...
	/**
	 * Constructs a new TankEnemy. The entity will be rendered at the same size
	 ...
	 */
	public TankEnemy(float posX, float posY, float posZ, float xLength, float yLength, float zLength,
			String texture, float maxHealth) {
		super(posX, posY, posZ, xLength, yLength, zLength, xLength, yLength, false, texture, maxHealth);
	}

	/**
	 * Constructs a new TankEnemy with specific render lengths. Allows
