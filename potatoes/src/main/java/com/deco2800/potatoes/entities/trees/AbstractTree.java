...
public abstract class AbstractTree extends AbstractEntity implements Tickable {
	...
	/**
	 * Adds an event to this tree that will trigger every tick when the tree is not being constructed, when
	 * getConstructionLeft() <= 0
	 * @param event the time event that will be triggered
	 */
	...
	/**
	 * Adds an event to this tree that will trigger every tick when the tree is being constructed, when
	 * getConstructionLeft() > 0
	 * @param event the time event that will be triggered
	 */
	...
	/**
	 * @param constructionLeft the percentage of construction to set, from 0 to 100
	 */
